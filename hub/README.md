...
explicit request.** This hub keeps read-only shallow clones of my projects (under
`../assets/references/`, git-ignored) to read what changed and blog about it; each
project keeps its own read-only shallow clone of this hub to refresh shared
