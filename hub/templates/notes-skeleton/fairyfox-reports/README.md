...
- One file per run: `YYYY-MM-DD-<procedure>.md` (e.g. `2026-06-25-adopting-updates.md`;
  suffix `-2` if two runs of the same procedure land in one day).
- Start from the template: `hub/templates/fairyfox-report.md`.
- Full standard: `hub/standards/process-reports.md` (pulled into
  `notes/reference/` when this project adopts it).
